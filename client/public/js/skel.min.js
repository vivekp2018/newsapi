  ...
  var _ = {
    ...
    unlock: function() {
      (_.lockState = null),
        (document.cookie =
          ...
          (_.config.useDomainLock ? "/" : window.location.pathname)),
        ...
        _[t](s, function(e) {
          ...
          _[t](s[e], function(t) {
            (a = _.locations[s[e][t].location]),
              a
                ? (a[r](s[e][t].object), s[e][t][i] && s[e][t][i]())
                : o.push(s[e][t]);
          });
        }),
        o.length > 0 &&
    ...
    poll: function() {
      ...
      _.lockState ? (s = _.lockState) : (s = _.getViewportWidth()),
        ...
        _.iterate(_[e], function(t) {
          _[e][t].test(s) && (o += _.sd + t);
        }),
        o === "" && (o = _.sd),
        o !== _[t] &&
          ((_[r].html[n] = _[r].html[n].replace(_[t], "")),
          _.changeState(o),
    ...
    changeState: function(e) {
      ...
      if (!_[i][r][_[n]]) {
        (_[i][r][_[n]] = { config: {}, elements: [], values: {} }),
          (F = _[i][r][_[n]]),
          ...
          _[s].resetCSS
            ? ((R = "iR"),
              (q = _[a](R)) || (q = _[f](R, _[l](_.css.r), c, 2)),
              F[p][h](q))
            : _[s].normalizeCSS &&
              ((R = "iN"),
              (q = _[a](R)) || (q = _[f](R, _[l](_.css.n), c, 2)),
              F[p][h](q)),
          _[s][d] &&
            ((R = "ssB"),
            (q = _[a](R)) || (q = _[f](R, _[v](_[s][d] + m), c, 4)),
            F[p][h](q)),
          (U = F[s][g]),
          F[s][y]
            ? (U += (U != "" ? b : "") + "width=" + F[s][y])
            : F[s][w] && (U += (U != "" ? b : "") + "width=device-width"),
          F[s][w] &&
            (U +=
              (U != "" ? b : "") +
          ...
          U != "" &&
            ((R = "mV" + _[n]),
            (q = _[a](R)) || (q = _[f](R, _.newMeta(g, U), c, 1)),
            F[p][h](q)),
          _[t].IEVersion >= 10 &&
            ((R = "mVIE" + _[n]),
            (q = _[a](R)) ||
              (q = _[f](R, _[l]("@-ms-viewport{width: device-width}"), c, 2)),
            F[p][h](q));
        var W, X;
        (I = _[E](F[s][S])),
          (W = I[0]),
      ...
      function buildTest(e, t) {
        ...
        return (
          ...
          t == "*"
            ...
            : t.charAt(0) == n
            ? ((fArgs[e] = parseInt(t.substring(1))),
              (r = function(t) {
                return t <= fArgs[e];
              }))
            : t.charAt(t.length - 1) == n
            ? ((fArgs[e] = parseInt(t.substring(0, t.length - 1))),
              (r = function(t) {
                return t >= fArgs[e];
              }))
            : _.indexOf(t, n) != -1
            ? ((t = t.split(n)),
              (fArgs[e] = [parseInt(t[0]), parseInt(t[1])]),
              (r = function(t) {
      ...
      window._skel_config
        ...
        (function() {
          ...
          typeof s == e &&
            ...
            (_[u][o][a] = _[r][a]),
            _.iterate(_[r][n], function(t) {
              typeof _[r][n][t] != e && (_[r][n][t] = { range: _[r][n][t] }),
                (c = {}),
                _[i](c, _[u][o]),
                _[i](c, _[r][n][t]),
                (_[r][n][t] = c),
                ...
                (b.elements = []),
                (_[n][t] = b),
                _[r].preloadStyleSheets &&
                  b[r].hasStyleSheet &&
                  preloads.push(_[r].prefix + "-" + t + ".css"),
